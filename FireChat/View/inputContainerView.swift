...
class inputContainerView: UIView {
    ...
    init(image:UIImage?, textField: UITextField) {
        ...
        let devidorView = UIView()
        devidorView.backgroundColor = .white
        addSubview(devidorView)
        devidorView.anchor(left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingLeft: 8, height: 0.75)
